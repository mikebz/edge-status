...
import (
	...
	"github.com/mikebz/edge-status/test/utils"
)
...
var (
	...
	projectImage = "example.com/edge-status:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting edge-status integration test suite\n")
